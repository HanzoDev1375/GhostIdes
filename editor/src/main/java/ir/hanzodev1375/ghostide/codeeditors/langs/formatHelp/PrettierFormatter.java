...
public class PrettierFormatter {
  ...
  public String format(Context context, String code, String formatcodeType) {
    ...
    File tempFile = new File(cacheDir, "temp_html_prettier.html");
    ...
    String tempFilePathInProot =
        dataDir + "/cache/temp_" + formatcodeType + "_prettier." + formatcodeType;
   ...
   // command.add(formatcodeType);
    ...
    try {
      ...
      // Prettier در صورت موفقیت exit code 0 برمی‌گرداند
      if (exitCode == 0) {
